...
def test_main():
    ...
    #     voter_audit_codes = audit_codes[voter_key]
    #     print(voter_key, voter)
    #     print(voter_key, voter_audit_codes)
    #     print()
    #     vote, _, _, _ = mk_random_vote(election, voter_key=voter_key, audit_code=voter_audit_codes[0])
    #     # votes.append(votes)
    # print()
    assert True
    # assert False
